			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"WorklistApp-display": {
								"semanticObject": "WorklistApp",
								"action": "display",
								"description": "A Fiori application for Worklist.",
								"title": "Worklist App",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.demo.worklist",
									"url": sap.ui.require.toUrl("com/demo/worklist")
								}
							}
						}
					}
